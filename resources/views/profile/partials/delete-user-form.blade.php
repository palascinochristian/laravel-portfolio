<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Una volta cancellato, non sarà più possibile recuperarne i dati. Assicurati di averli salvati prima di procedere con la cancellazione definitiva del tuo account.') }}
        </p>
    </header>
